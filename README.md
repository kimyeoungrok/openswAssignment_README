...
![잘된이미지표](https://github.com/kimyeoungrok/openswAssignment_README/assets/127182406/030a6ab9-3157-4801-b538-0aaebde905d7)  
  
대다수의 이미지들에 검은색, 회색 계열의 색깔이 주로 들어가있음을 알 수 있습니다.  
  
이번에는 잘 안된 이미지들의 평균 RGB값을 보겠습니다.  
![잘안된이미지표](https://github.com/kimyeoungrok/openswAssignment_README/assets/127182406/5d33358f-14d3-4648-bdf0-c49d6dc2e996)  
대다수의 이미지에 노란색, 갈색 계열의 색깔이 주로 들어가있음을 알 수 있습니다.  

<최종분석 결론>
분석 결과 저희가 clone한 모델은 건물카테고리의 이미지와 이미지 주요 색깔이 검은색, 회색 계열을 띄는 이미지를 colorization을 시키는데 있어서  
